...
__forceinline__ __device__ void compute_attn_1rowblock_splitkv_mla(const Flash_fwd_mla_params_fp8 &params,
...
flash_fwd_splitkv_mla_kernel(__grid_constant__ const Flash_fwd_mla_params_fp8 params) {
    constexpr int kBlockN = Kernel_traits::kBlockN;
...
flash_fwd_splitkv_mla_combine_kernel(__grid_constant__ const Flash_fwd_mla_params_fp8 params) {
